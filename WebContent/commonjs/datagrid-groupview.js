		...
		function initCss(){
			if (!$('#datagrid-group-style').length){
				$('head').append(
					...
					'.datagrid-group{height:'+opts.groupHeight+'px;width:'+opts.groupWidth+'%;width:100%;overflow:hidden;font-weight:bold;border-bottom:1px solid #ccc;white-space:nowrap;word-break:normal;}' +
