...
var con="<div class=\"messager-progress\" style=\"font-weight: bold;\"><img src='css/images/loading.gif' alt='Wait'  />&nbsp;&nbsp;&nbsp;Loading... Please Wait..</div>";
var dlg=_2ca($.extend({},
		$.messager.defaults,
		{content:con,//"<div class=\"messager-progress\"><div class=\"messager-p-msg\">"+opts.msg+"</div><div class=\"messager-p-bar\"></div></div>",
	closable:false,
	doSize:false},opts,{onClose:function(){
//if(this.timer){
